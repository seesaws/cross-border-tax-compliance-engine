...
def read_orders_from_excel(file_path: str | Path) -> list[Order]:
    """从 Excel 文件读取订单列表

    Excel 模板列: order_id, country, currency, item_name, quantity, unit_price, hs_code, category, shipping_cost
    """
...
def write_results_to_excel(results: list[dict], output_path: str | Path) -> None:
    """将计算结果写入 Excel 文件"""
